...
import 'package:flutter_app_trainign/model/exercise_model.dart';
import 'package:flutter_app_trainign/model/routine_model.dart';
...
class DBHelper {
  ...
  Future<Database> initDB() async {
    io.Directory documentoDirectory = await getApplicationDocumentdirectory();
    String path = join(documentoDirectory.path, 'fworkout.db');
  ...
  void saveUser(String name, String email, String password)async{
    ...
    await dbClient.transaction((txn)async{
      return await txn.rawInsert( 'INSERT INTO User(name, email, password) VALUES(\'$name\', \'$email\', \'$password\')');
    });
